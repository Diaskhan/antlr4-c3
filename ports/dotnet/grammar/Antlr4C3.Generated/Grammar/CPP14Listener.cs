...
public interface ICPP14Listener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTypename([NotNull] CPP14Parser.TypenameContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.typename"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTypename([NotNull] CPP14Parser.TypenameContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterTypeid([NotNull] CPP14Parser.TypeidContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.typeid"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitTypeid([NotNull] CPP14Parser.TypeidContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterOperator([NotNull] CPP14Parser.OperatorContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.operator"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitOperator([NotNull] CPP14Parser.OperatorContext context);
	/// <summary>
